...
import {
  Search, Plus, MoreHorizontal, Edit, Trash2, Mail, Phone, Download,
  Loader2, Eye,
} from 'lucide-react'
...
function DietitiansPage() {
  ...
  const handleExportCsv = () => {
    const headers = ['Ad', 'Soyad', 'E-posta', 'Telefon', 'Durum', 'Oluşturulma']
    ...
    link.href = url
    link.download = `diyetisyenler-${new Date().toISOString().slice(0, 10)}.csv`
    link.click()
    URL.revokeObjectURL(url)
    toast.success('Diyetisyen listesi indirildi')
  }
